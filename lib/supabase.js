...
(function (global) {
  ...
  function injectOverlay() {
    const css = `
      ...
      #sbLoginOverlay .b{background:#161b22;border:1px solid #30363d;border-radius:12px;padding:28px 30px;width:340px;white-space:normal;font-size:14px;font-weight:normal}
      #sbLoginOverlay h2{font-size:17px;color:#fff;margin:0 0 14px}
      #sbLoginOverlay input{display:block;width:100%;background:#0d1117;border:1px solid #30363d;color:#c9d1d9;padding:9px 12px;border-radius:8px;margin-bottom:10px;font-size:13px;box-sizing:border-box}
      #sbLoginOverlay button{display:block;width:100%;background:#58a6ff;border:none;color:#04101f;font-weight:700;padding:10px;border-radius:8px;cursor:pointer;font-size:13.5px}
